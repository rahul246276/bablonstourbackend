...
router.patch('/:id', authorize('super_admin', 'admin'), validate(updateHotelSchema), hotelController.updateHotel)
router.delete('/:id', authorize('super_admin', 'admin'), validate(hotelIdSchema), hotelController.deleteHotel)
router.patch('/:id/status', authorize('super_admin', 'admin'), validate(toggleHotelStatusSchema), hotelController.toggleHotelStatus)
